            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-wrap -mx-4 justify-center items-center">
                    <div className="p-4 w-full lg:w-4/12 sm:w-4/6">
                        <img
                            src="https://images.unsplash.com/photo-1613909207039-6b173b755cc1?ixid=MnwyMDkyMnwwfDF8c2VhcmNofDV8fGRlc2lnbmVyfGVufDB8fHx8MTYzMjg2OTMwMA&ixlib=rb-1.2.1&q=85&fm=jpg&crop=faces&cs=srgb&w=800&h=1000&fit=crop"
                            className="rounded-xl w-full shadow-lg" alt="Portrait of Keuri Castillo" width="600" height="650"/>
                    </div>
                    <div className="p-4 w-full lg:w-8/12">
                        ...
                        <a href="#"
                           className="bg-[#1469b5] hover:bg-[#12497a] inline-block px-6 py-2 rounded text-white transition-colors duration-200 ease-in-out">Full Story</a>
                    </div>
                </div>
            </div>
        </section>
